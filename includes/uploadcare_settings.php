...
<?php if ( $connectError !== null ): ?>
    <div class="error">
        <p>
            <strong><?= __( 'Can\'t connect to the Uploadcare account. Check your public & secret keys. Follow plugin setup instructions down below.' ) ?></strong>
        </p>
        <p id="error-collapse-toggle" class="uc-toggle"
           style="color: #0d66c2; text-decoration: underline"><?= __( 'More information' ) ?></p>
...
<div class="wrap">
    ...
    <form name="oscimp_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI'] ); ?>">
        ...
        <h4><?= __( '2. Get your Uploadcare project API keys', 'uploadcare' ) ?> <a
        ...
        <h4><?= __( '3. Select Upload Sources', 'uploadcare' ) ?> <a
        ...
        <div id="uc-advanced-options" data-toggle="uc-collapse-toggle" class="uc-collapsed hide">
            <h4><?= __( 'Adaptive Delivery', 'uploadcare' ) ?> <a
            ...
            <h4><?= __( 'Custom CDN CNAME', 'uploadcare' ) ?> <a
            ...
            <h4><?= __( 'Secure Uploading', 'uploadcare' ) ?> <a
            ...
            <h4><?= __( 'File Uploader fine tuning', 'uploadcare' ) ?> <a
            ...
            <p>
                <textarea style="font-family: monospace" name="uploadcare_finetuning" id="uc_uploadcare_finetuning"
                          rows="10" cols="75"><?= \trim( \stripslashes( $uploadcare_finetuning ) ) ?></textarea>
            </p>
        </div>
